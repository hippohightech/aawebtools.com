# Translation Brief — paystub-generator → German (de)
...
> **After completion**: Save to `frontend/de/gehaltsabrechnungs-generator/index.html`, then run verify.
...
| Target file | `frontend/de/gehaltsabrechnungs-generator/index.html` |
| Target canonical | `https://aawebtools.com/de/gehaltsabrechnungs-generator/` |
...
4. **`<link rel="canonical" href="https://aawebtools.com/de/gehaltsabrechnungs-generator/">`** — must exactly match.
...
After pasting the translated HTML into `frontend/de/gehaltsabrechnungs-generator/index.html`, run:

```bash
node tools/translate/build.js 2>&1 | grep -A 6 "FAIL de/paystub-generator$" || echo "PASS — page validates"
```
...
```bash
git add frontend/de/gehaltsabrechnungs-generator/index.html
git commit -m "Regenerate de/paystub-generator (passes validator)"
```
